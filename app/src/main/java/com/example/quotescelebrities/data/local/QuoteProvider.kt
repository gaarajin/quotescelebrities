...
class QuoteProvider {
    companion object { //clase estatica: se van a cargar desde un principio
        ...
        private val quotes = listOf(
            QuoteModel(//agregamos los objetos
                id = 1,
            ...
            QuoteModel(
                ...
                quote = """Una vez un ordenador me venció jugando al ajedrez, pero no me opuso 
                    |resistencia cuando pasamos al kick boxing""".trimMargin(),//quitar espacios en blanco en ambos lados,
                author = "Emo Philips"
            ),
            QuoteModel(
                id = 5,
